...
from .models import Subscription, Newsletter, Submission, Message
...
class SubmissionAdminForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['message'].queryset = Message.objects.filter(newsletter__condominium=self.current_condominium)
