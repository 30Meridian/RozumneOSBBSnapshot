...
class Newsletter(models.Model):
    ...
    condominium = models.ForeignKey(Condominium, blank=True, null=True, verbose_name=_('Condominium'))

    site = models.ManyToManyField(Site, default=get_default_sites, verbose_name=_('site'))

    title = models.CharField(
        max_length=200, verbose_name=_('newsletter title')
    )
    slug = models.SlugField(db_index=True, unique=True, verbose_name=_('slug'))
