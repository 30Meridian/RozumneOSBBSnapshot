...
class FormForumAdmin(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(FormForumAdmin, self).__init__(*args, **kwargs)
        self.fields['parent'].queryset = Forum.objects.filter(condominium=self.current_condominium)
...
class PickUserForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.fields['user'].queryset = User.objects.filter(condominiums)
...
from . import models
from machina.apps.forum_conversation import admin as conv_admin
from machina.apps.forum_conversation.forum_attachments import admin as attachments_admin
from machina.apps.forum_conversation.forum_polls import admin as polls_admin
from machina.apps.forum_member import admin as member_admin
from machina.apps.forum_permission import admin as permission_admin
from machina.apps.forum_tracking import admin as tracking_admin


admin.site.unregister(conv_admin.Topic)
admin.site.unregister(conv_admin.Post)

admin.site.unregister(attachments_admin.Attachment)
admin.site.unregister(polls_admin.TopicPoll)
# admin.site.unregister(polls_admin.TopicPollOption)
admin.site.unregister(polls_admin.TopicPollVote)

admin.site.unregister(member_admin.ForumProfile)

admin.site.unregister(permission_admin.ForumPermission)
admin.site.unregister(permission_admin.GroupForumPermission)
admin.site.unregister(permission_admin.UserForumPermission)

admin.site.unregister(tracking_admin.ForumReadTrack)
admin.site.unregister(tracking_admin.TopicReadTrack)


admin.site.register(models.ProxyForumConversationTopic, conv_admin.TopicAdmin)
admin.site.register(models.ProxyForumConversationPost, conv_admin.PostAdmin)
admin.site.register(models.ProxyForumConversationAttachment, attachments_admin.AttachmentAdmin)
admin.site.register(models.ProxyForumConversationTopicPoll, polls_admin.TopicPollAdmin)
# admin.site.register(models.ProxyForumConversationTopicPollOption, polls_admin.TopicPollOptionAdmin)
admin.site.register(models.ProxyForumConversationTopicPollVote, polls_admin.TopicPollVoteAdmin)
admin.site.register(models.ProxyForumProfile, member_admin.ForumProfileAdmin)
admin.site.register(models.ProxyForumPermission, permission_admin.ForumPermissionAdmin)
admin.site.register(models.ProxyGroupForumPermission, permission_admin.GroupForumPermissionAdmin)
admin.site.register(models.ProxyUserForumPermission, permission_admin.UserForumPermissionAdmin)
admin.site.register(models.ProxyForumReadTrack, tracking_admin.ForumReadTrackAdmin)
admin.site.register(models.ProxyTopicReadTrack, tracking_admin.TopicReadTrackAdmin)