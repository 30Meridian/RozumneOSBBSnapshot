...
class PermissionHandler(object):
    ...
    def can_edit_post(self, post, user, condominium):
        """
        ...
        # request.session.condominium_slug in request.user.is_manager
        # print (self.request.session['condominium_slug'] in request.user.is_manager)
        ...
        can_edit = ( user.is_superuser or
                    ...
                    checker.has_perm('can_edit_posts', post.topic.forum) and condominium in user.is_manager())
        return can_edit

    def can_delete_post(self, post, user, condominium):
        """
        ...
        can_delete = (user.is_superuser or
                      ...
                      checker.has_perm('can_delete_posts', post.topic.forum) and condominium in user.is_manager())
        return can_delete
