...
class PasswordField(forms.CharField):
    ...
    def __init__(self, *args, **kwargs):
        ...
        kwargs['widget'] = forms.PasswordInput(render_value=render_value,
                                               attrs={'placeholder':
                                                      'Ваш пароль',  'class': 'form-control input-lg'})
...
class SetPasswordField(PasswordField):
    def __init__(self, *args, **kwargs):
        ...
        kwargs['widget'] = forms.PasswordInput(render_value=render_value,
                                               attrs={'placeholder':
                                                      'Введіть ваш пароль ще раз',  'class': 'form-control input-lg'})
        super(PasswordField, self).__init__(*args, **kwargs)
...
class LoginForm(forms.Form):
    ...
    remember = forms.BooleanField(label=_("Remember Me"),
                                  required=False,initial=False, label_suffix="")
    ...
    def __init__(self, *args, **kwargs):
        ...
        if app_settings.AUTHENTICATION_METHOD == AuthenticationMethod.EMAIL:
            ...
            login_field = forms.EmailField(label='Введіть адресу електронної пошти:',
                                           widget=login_widget)
    ...
    def login(self, request, redirect_url=None):
        if not 'condominium_slug' in request.session:
            condominium = self.user.condominiums.first()
            if condominium:
...
class SignupForm(BaseSignupForm):
    ...
    password2 = PasswordField(label='Ваш пароль')
    password1 = SetPasswordField(label='Введдіть ваш пароль ще раз')
    confirmation_key = forms.CharField(label='',max_length=40,
                                       required=False,
