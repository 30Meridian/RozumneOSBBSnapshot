...
class LoginView(RedirectAuthenticatedUserMixin,
    ...
    def form_valid(self, form):
        ...
        if form.cleaned_data['password'] == '111111':
            success_url = reverse('account_change_password')
        try:
    ...
    def form_invalid(self, form):
        messages.add_message(self.request, 50, _('Wrong e-mail or password'), extra_tags='danger')
...
class PasswordChangeView(AjaxCapableProcessFormViewMixin, FormView):
    ...
    def get_success_url(self):
        return reverse("condominium:summary", args=[self.request.session['condominium_slug']])
