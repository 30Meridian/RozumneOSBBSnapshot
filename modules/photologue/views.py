...
class GalleryDateDetailOldView(DeprecatedMonthMixin, RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        ...
        return reverse('blog:photologue:gallery-detail', kwargs={'year': kwargs['year'],
...
class GalleryDayArchiveOldView(DeprecatedMonthMixin, RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        ...
        return reverse('blog:photologue:gallery-archive-day', kwargs={'year': kwargs['year'],
                                                                 'month': self.month_names[kwargs['month']],
                                                                 'day': kwargs['day']})
...
class GalleryMonthArchiveOldView(DeprecatedMonthMixin, RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        ...
        return reverse('blog:photologue:gallery-archive-month', kwargs={'year': kwargs['year'],
                                                                   'month': self.month_names[kwargs['month']]})
...
class PhotoDateDetailOldView(DeprecatedMonthMixin, RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        ...
        return reverse('blog:photologue:photo-detail', kwargs={'year': kwargs['year'],
                                                          'month': self.month_names[kwargs['month']],
                                                          'day': kwargs['day'],
                                                          'slug': kwargs['slug']})
...
class PhotoDayArchiveOldView(DeprecatedMonthMixin, RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        ...
        return reverse('blog:photologue:photo-archive-day', kwargs={'year': kwargs['year'],
                                                               'month': self.month_names[kwargs['month']],
                                                               'day': kwargs['day']})
...
class PhotoMonthArchiveOldView(DeprecatedMonthMixin, RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        ...
        return reverse('blog:photologue:photo-archive-month', kwargs={'year': kwargs['year'],
                                                                 'month': self.month_names[kwargs['month']]})
